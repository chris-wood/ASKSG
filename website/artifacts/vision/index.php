...
<div class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="row-fluid">
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class='active'><a href="<?php echo $dir_info;?>artifacts/vision/">Vision and Scope</a></li>
        ...
        <div class="span9">
          ...
          <iframe src="https://docs.google.com/document/d/1mOZpSDHDJc06cofqeYIa368WhUgseLUHn6i9lIEqmFg/pub?embedded=true" width="650" height="800"></iframe>
